...
精简版是基于 [vue-pure-admin](https://github.com/xiaoxian521/vue-pure-admin)
提炼出的架子，包含主体功能，更适合实际项目开发，打包后的大小仅 `3MB`，并且会永久同步完整版的代码
...
- 精简版不接受任何 `issues` 和 `pr`
  ，如果有问题请到完整版 [issues](https://github.com/xiaoxian521/vue-pure-admin/issues/new/choose) 去提，谢谢！！！
- 不要使用 `delete-i18n`
  分支代码，这个分支只是给你们完全删除国际化的参考，不会同步代码的！！！ [完全删除国际化教程](https://www.bilibili.com/video/BV1Ru411B7k3/)
  ，请务必使用 `main` 分支的代码！！！
