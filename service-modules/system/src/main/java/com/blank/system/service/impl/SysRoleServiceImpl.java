...
import com.blank.system.api.domain.SysRoleMenu;
...
public class SysRoleServiceImpl implements ISysRoleService {
    ...
    private Wrapper<SysRole> buildQueryWrapper(SysRole role) {
        ...
        wrapper.eq("r.is_deleted", Constants.IS_DELETED_N)
                .eq(ObjectUtil.isNotNull(role.getRoleId()), "r.role_id", role.getRoleId())
                .like(com.baomidou.mybatisplus.core.toolkit.StringUtils.isNotBlank(role.getRoleName()), "r.role_name", role.getRoleName())
                .eq(com.baomidou.mybatisplus.core.toolkit.StringUtils.isNotBlank(role.getStatus()), "r.status", role.getStatus())
